        ...
        <div class="card-body">
            <form action="<?= base_url(). "matakuliah/insert";?>" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="kode_matakuliah" id="kode_matakuliah" class="form-control" placeholder="kode_matakuliah" require>
            </div>
                <div class="form-group">
                    <label for="nama_matakuliah">Nama Matakuliah</label>
                    <input type="text" name="nama_matakuliah" id="nama_matakuliah" class="form-control" placeholder="nama_matakuliah" require>
            </div>
                <div class="form-group">
                    <label for="sks">Sks</label>
                    <select name="sks" id="sks" class="form-control" placeholder="sks" require>
                ...
                <div class="form-group">
                    ...
                    <select name="semester" id="semester" class="form-control" placeholder="semester" require>
                ...
                <select name="jenis" id="jenis" class="form-control" placeholder="jenis" require>
                ...
                <select name="prodi" id="prodi" class="form-control" placeholder="prodi" require>
